...
namespace geode {
    ...
    public:
         ...
         * @param activateCallback The callback for when the button is activated
         */
        static Button* createWithSprite(std::string_view fileName, ButtonCallback activateCallback = nullptr);
         ...
         * @param activateCallback The callback for when the button is activated
         */
        static Button* createWithSpriteFrameName(std::string_view frameName, ButtonCallback activateCallback = nullptr);
         ...
         * @param activateCallback The callback for when the button is activated
         */
        static Button* createWithLabel(std::string_view text, std::string_view font, ButtonCallback activateCallback = nullptr);
    ...
    protected:
        ...
        bool initWithSprite(std::string_view fileName, ButtonCallback activateCallback);
        bool initWithSpriteFrameName(std::string_view frameName, ButtonCallback activateCallback);
        bool initWithLabel(std::string_view text, std::string_view font, ButtonCallback activateCallback);
